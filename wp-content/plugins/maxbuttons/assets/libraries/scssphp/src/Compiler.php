...
use MaxButtons\ScssPhp\ScssPhp\Block\AtRootBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\CallableBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\DirectiveBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\EachBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\ElseBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\ElseifBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\ForBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\IfBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\MediaBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\NestedPropertyBlock;
use MaxButtons\ScssPhp\ScssPhp\Block\WhileBlock;
...
class Compiler
{
    ...
    /**
     * @var \MaxButtons\ScssPhp\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \MaxButtons\ScssPhp\ScssPhp\Parser
     */
     ...
     *
     * @return \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock
     */
     ...
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $scope
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Block|\MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \MaxButtons\ScssPhp\ScssPhp\Formatter\OutputBlock $out
     * @param \MaxButtons\ScssPhp\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
     ...
     *
     * @param \MaxButtons\ScssPhp\ScssPhp\Compiler\Environment $env
     * @param \MaxButtons\ScssPhp\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \MaxButtons\ScssPhp\ScssPhp\Block $block
     *
     * @return \MaxButtons\ScssPhp\ScssPhp\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\MaxButtons\ScssPhp\ScssPhp\ValueConverter::parseValue" or "\MaxButtons\ScssPhp\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \MaxButtons\ScssPhp\ScssPhp\Compiler
     *
     ...
     * @return never
     *
     * @throws \MaxButtons\ScssPhp\ScssPhp\Exception\CompilerException
     *
