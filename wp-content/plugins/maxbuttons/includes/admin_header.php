...
$mainclass = isset($_REQUEST["page"]) ? esc_attr(sanitize_text_field($_REQUEST["page"])) : '';
$action = isset($_REQUEST["action"]) ? esc_attr(sanitize_text_field($_REQUEST["action"])) : $action;
if ($action !== '')
	$mainclass .= '-' . $action;
?>
